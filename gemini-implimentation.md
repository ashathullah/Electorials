...
Gemini models are trained to think through complex problems, leading to significantly improved reasoning. The Gemini API comes with[thinking parameters](https://ai.google.dev/gemini-api/docs/thinking)which give fine grain control over how much the model will think.
